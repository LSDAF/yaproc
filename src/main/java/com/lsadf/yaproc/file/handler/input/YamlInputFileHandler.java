...
/**
 * A handler for processing input files in YAML format. This class uses {@link YAMLMapper}
 * to parse the YAML content into a {@link ContentMap} object. It supports chaining multiple
 * handlers where unsupported file formats can be delegated to the next handler in the chain.
 * If no handler exists, an {@link UnsupportedFileFormatException} is thrown when processing
 * unsupported formats.
 */
